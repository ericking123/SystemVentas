...
namespace SysVenta.DAL.DBContext;
...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C1DFEFAD5");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FD3A6D7EA");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4839033F9CF");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107312E8BF8");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547ED4ECCCA1");
            ...
            entity.Property(e => e.FechaActualizada)
                .HasColumnType("datetime")
                .HasColumnName("fechaActualizada");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132961DFFAC");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F765569A707");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D87EE98BB4");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE9B0827D4");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A607549320");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56146713D330");
